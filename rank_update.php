            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> Edit Rank </h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="form-sample" method="post" id="myform">
                                        ...
                                        if(isset($_GET["up_id"])) {
                                            $id = $_GET["up_id"];
                                            $sql = "SELECT * FROM tbl_rank WHERE r_id=$id";
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="rname" value="<?php echo $row["r_name"] ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        if(isset($_POST["btn"])) {
                                            $name = $_POST["rname"];
                                            $sql = "UPDATE tbl_rank SET r_name='$name' WHERE r_id=$id";
                                        ...
                                        <a href="rank_view.php" class="btn btn-dark">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
