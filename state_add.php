                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_POST["btn"])) {
                                        ...
                                        $check_sql = "SELECT * FROM tbl_state_details WHERE UPPER(state_name) = '$name'";
                                        $check_res = mysqli_query($conn, $check_sql) or die(mysqli_error($conn));

                                        if (mysqli_num_rows($check_res) > 0) {
                                            // State name already exists
                                            echo "The state name already exists. Please try a different name.";
                                        } else {
                                            $sql = "INSERT INTO tbl_state_details (state_name,is_active) VALUES ('$name','$active');";
