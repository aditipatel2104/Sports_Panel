            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> New Add Game Type </h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="sactive" id="membershipRadios1" value="on" checked> Active </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="sactive" id="membershipRadios2" value="off"> InActive </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> -->
                                    ...
                                    if (isset($_POST["btn"])) {
                                        ...
                                        $name = strtoupper($_POST["gtype"]);
                                       

                                        // Check if the state name already exists
                                        $check_sql = "SELECT * FROM tbl_game_type WHERE UPPER(game_type) = '$name'";
                                        $check_res = mysqli_query($conn, $check_sql) or die(mysqli_error($conn));

                                        if (mysqli_num_rows($check_res) > 0) {
                                            // State name already exists
                                            echo "The game type  already exists. Please try a different name.";
                                        } else {
                                            $sql = "INSERT INTO tbl_game_type (game_type) VALUES ('$name');";
            ...
            $("#myform").validate({
                ...
                messages: {
                    gtype: {
                        ...
                        minlength: "Game type must be at least 2 characters long"
                    }
                }
            });
        });
