                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="corsename" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <?php
                                        if(isset($_POST["btn"]))
                                        {
                                            ...
                                            $name =strtoupper( $_POST["corsename"]);
                                            // Check if the state name already exists
$check_sql = "SELECT * FROM tbl_clg_courses WHERE UPPER(course_name) = '$name'";
$check_res = mysqli_query($conn, $check_sql) or die(mysqli_error($conn));

if (mysqli_num_rows($check_res) > 0) {
    // State name already exists
    echo "The course name already exists. Please try a different name.";
} else {
                                            $sql = "INSERT INTO tbl_clg_courses (course_name) VALUES ('$name');";
