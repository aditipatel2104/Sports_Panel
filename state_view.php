...
<body>
    ...
    <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" href="state_add.php">Add</a>
</li>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET["del_id"])) {
                                                    $d_id = $_GET["del_id"];
                                                    $sql = "DELETE FROM tbl_state_details WHERE st_id=$d_id";
                                                ...
                                                ?>
                                                    ...
                                                    <td><?php echo $serial_number++; ?></td> <!-- Display serial number -->
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="hidden" name="state_id" value="<?php echo $row["st_id"]; ?>">
                                                            ...
                                                            <?php 
                                                                      if (isset($_POST["update_status"])) {
                                                                       ...
                                                                       // echo "hello" . $id;
                                                                          ...
                                                                          $sql = "UPDATE tbl_state_details SET is_active='$new_status' WHERE st_id=$id";
                                                                          $res = mysqli_query($conn, $sql);
                                                                          if ($res) {
                                                                              echo "<script>window.location = 'state_view.php';</script>";
                                                                          } else {
                                                        ...
                                                        <td>
                                                            <div class="template-demo">
                                                                <a type="button" class="btn btn-danger btn-icon-text" href="state_view.php?del_id=<?php echo $row["st_id"]; ?>">
                                                                    <i class="mdi mdi-delete"></i> Delete
                                                                </a>
                                                                <a type="button" class="btn btn-warning btn-icon-text" href="state_update.php?up_id=<?php echo $row["st_id"]; ?>">
