            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> New Add Tournament Result </h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_POST["btn"])) {
                                        ...
                                        $check_sql =  "SELECT * FROM tbl_tournament_result WHERE t_id = '$id' AND cl_id = '$clid' AND r_id = '$rid'";
                                        $check_res = mysqli_query($conn, $check_sql) or die(mysqli_error($conn));

                                        if (mysqli_num_rows($check_res) > 0) {
                                            // Tournament result already exists
                                            echo "The tournament result already exists!";
                                        } else {
                                            $sql = "INSERT INTO tbl_tournament_result (t_id, cl_id, r_id) VALUES ('$id', '$clid', '$rid');";
