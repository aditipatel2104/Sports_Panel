            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> Edit Coach </h3>
...
{
    $id=$_GET["up_id"];
    $sql = "SELECT * FROM tbl_coach_details where co_id=$id";
...
?>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" name="gen" id="membershipRadios1" value="Male" <?php echo ($row['co_gender'] == 'Male') ? 'checked' : ''; ?>> Male </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" name="gen" id="membershipRadios2" value="Female" <?php echo ($row['co_gender'] == 'Female') ? 'checked' : ''; ?>> Female </label>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="address" value="<?php echo $row["co_address"] ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST["btn"]))
                                        {
                                            ...
                                            $address = $_POST["address"];
                                              ...
                                              $sql = "UPDATE tbl_coach_details SET co_code='$code',co_name='$name',co_contact='$contact',co_gender='$gender',co_address='$address' WHERE co_id = $id";
